...
function createNewList() {
	if (addNewListInput.value == "") {
		...
		localStorage.setItem("lists", JSON.stringify(_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists));
	}
}
			...
			for (let i = 0; i < _lists_js__WEBPACK_IMPORTED_MODULE_1__.lists.length; i++) {
				if (_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].name == e.target.parentElement.innerText) {
					if (_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists.length == 1) {
						...
						return;
					} else if (_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].name == "Default") {
...
function getLocalStorage() {
	if (localStorage.getItem("lists") == null) {
		...
		stored_data.forEach((list) => {
			_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists.push(list);
