...
const defaultList = new _lists_js__WEBPACK_IMPORTED_MODULE_1__.List("Default", []);
_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists.push(defaultList);
...
function init() {
	...
	doneButton.addEventListener("click", (e) => {
		addTaskToDiv();
		sortTasks();
		console.log(_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists);
	});
...
function createNewList() {
	if (addNewListInput.value == "") {
		...
		_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists.push(new _lists_js__WEBPACK_IMPORTED_MODULE_1__.List(addNewListInput.value, []));
...
function deleteList() {
	document.addEventListener("click", (e) => {
		if (e.target.dataset.delete == e.target.parentElement.innerText) {
			let index;
			for (let i = 0; i < _lists_js__WEBPACK_IMPORTED_MODULE_1__.lists.length; i++) {
				if (_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].name == e.target.parentElement.innerText) {
					if (_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists.length == 1) {
						alert("Error: Cannot delete all lists");
						return;
					} else {
						_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists.splice(i, 1);
					}
				}
			}
...
function showTasksCorrespondingToList() {
	sortTasks();
	_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists.forEach((list) => {
        ...
        <span
            >Due date <br />
            ${(0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(new Date(task.dueDate), "MM/dd/yyyy")}
        </span>
...
function swapListOnDelete() {
	const swapDefault = document.querySelector(
		`[data-list="${_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[0].name}"]`
	);
...
function addTaskToDiv() {
	...
	const task = new _tasks_js__WEBPACK_IMPORTED_MODULE_0__.Task(
		`${title.value}`,
		`${description.value}`,
		`${dueDate.value}`,
		urgent.checked,
	...
	newTask.innerHTML = `<div class="priority"></div>
        ...
        <span
            >Due date <br />
            ${(0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(new Date(dueDate.value), "MM/dd/yyyy")}
        </span>
        <i class="fas fa-edit"></i>`;
...
function deleteTask() {
	document.addEventListener("click", (e) => {
		if (e.target.classList.contains("delete-task")) {
			...
			deleteButton.remove();
			for (let i = 0; i < _lists_js__WEBPACK_IMPORTED_MODULE_1__.lists.length; i++) {
				for (let j = 0; j < _lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks.length; j++) {
					if (
						_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks[j].title ==
						e.target.parentElement.dataset.task
					) {
						_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks.splice(j, 1);
					}
				}
			}
		}
			...
			for (let i = 0; i < _lists_js__WEBPACK_IMPORTED_MODULE_1__.lists.length; i++) {
				for (let j = 0; j < _lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks.length; j++) {
					if (
						...
						_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks[j].complete =
							!_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks[j].complete;
						console.log(_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks[j].complete);
					}
				}
			}
		}
		...
		if (e.target.classList.contains("fa-edit")) {
			...
			for (let i = 0; i < _lists_js__WEBPACK_IMPORTED_MODULE_1__.lists.length; i++) {
				for (let j = 0; j < _lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks.length; j++) {
					if (
						...
						setForms(
							_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks[j].title,
							_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks[j].description,
							_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks[j].dueDate,
							_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks[j].urgent,
							_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks[j].normal
						);
					}
				}
			}
			editButton.addEventListener("click", (e) => {
				if (
					...
					console.log("test");
					console.log("test2");
					_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[indexI].tasks[indexJ].title = title.value;
					_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[indexI].tasks[indexJ].description = description.value;
					_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[indexI].tasks[indexJ].dueDate = dueDate.value;
					_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[indexI].tasks[indexJ].urgent = urgent.checked;
					_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[indexI].tasks[indexJ].normal = normal.checked;
...
function sortTasks() {
	for (let i = 0; i < _lists_js__WEBPACK_IMPORTED_MODULE_1__.lists.length; i++) {
		if (_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks.length == 0) {
			console.log("What");
		} else {
			_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks.sort(function (a, b) {
			...
			console.log("sorted");
			_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks.sort((a, b) => b.urgent - a.urgent);
			console.log("sorted");
			_lists_js__WEBPACK_IMPORTED_MODULE_1__.lists[i].tasks.sort((a, b) => a.complete - b.complete);
			console.log("sorted");
		}
	}
}
